...
#ifndef _aspect_boundary_composition_bounded_initial_composition_h
#define _aspect_boundary_composition_bounded_initial_composition_h
...
namespace aspect
{
  namespace BoundaryComposition
  {
     ...
     */
    template <int dim>
    class BoundedInitialComposition : public Interface<dim>, public SimulatorAccess<dim>
    {
      public:
        /**
