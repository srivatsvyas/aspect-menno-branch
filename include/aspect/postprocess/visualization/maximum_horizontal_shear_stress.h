...
#ifndef _aspect_postprocess_visualization_maximum_horizontal_shear_stress_h
#define _aspect_postprocess_visualization_maximum_horizontal_shear_stress_h
...
namespace aspect
{
  namespace Postprocess
  {
    namespace VisualizationPostprocessors
    {
       ...
       */
      template <int dim>
      class MaximumHorizontalShearStress
