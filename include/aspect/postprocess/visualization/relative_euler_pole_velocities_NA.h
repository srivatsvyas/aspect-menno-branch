...
#ifndef _aspect_postprocess_visualization_RelativeEulerPoleVelocitiesNA_h
#define _aspect_postprocess_visualization_RelativeEulerPoleVelocitiesNA_h
...
namespace aspect
{
  namespace Postprocess
  {
    namespace VisualizationPostprocessors
    {
       ...
       */
      template <int dim>
      class RelativeEulerPoleVelocitiesNA
