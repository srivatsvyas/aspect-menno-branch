...
#ifndef _aspect_postprocess_visualization_RelativeEulerPoleVelocitiesJdF_h
#define _aspect_postprocess_visualization_RelativeEulerPoleVelocitiesJdF_h
...
namespace aspect
{
  namespace Postprocess
  {
    namespace VisualizationPostprocessors
    {
       ...
       */
      template <int dim>
      class RelativeEulerPoleVelocitiesJdF
