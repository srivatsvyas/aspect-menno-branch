  ...
  namespace Postprocess
  {
    ...
    class CrystalPreferredOrientation : public Interface<dim>, public ::aspect::SimulatorAccess<dim>
    {
      ...
      private:
        ...
        enum class Output
        {
          VolumeFraction, RotationMatrix, EulerAngles, VolumeDerivative, DislocationDensity,SchmidFactor,RRSS,DeformationMechanismFactor,RecrystalizationIncrement,ParentGrain, not_found
        };
