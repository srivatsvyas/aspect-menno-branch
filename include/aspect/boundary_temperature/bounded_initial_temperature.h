...
#ifndef _aspect_boundary_temperature_bounded_initial_temperature_h
#define _aspect_boundary_temperature_bounded_initial_temperature_h
...
namespace aspect
{
  namespace BoundaryTemperature
  {
     ...
     */
    template <int dim>
    class BoundedInitialTemperature : public Interface<dim>, public ::aspect::SimulatorAccess<dim>
    {
      public:
        /**
