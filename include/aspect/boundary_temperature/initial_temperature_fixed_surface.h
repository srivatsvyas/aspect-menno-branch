...
#ifndef __aspect__boundary_temperature_initial_temperature_fixed_surface_h
#define __aspect__boundary_temperature_initial_temperature_fixed_surface_h
...
namespace aspect
{
  namespace BoundaryTemperature
  {
     ...
     */
    template <int dim>
    class InitialTemperatureFixedSurface : public Interface<dim>, public ::aspect::SimulatorAccess<dim>
    {
      public:
        /**
      ...
      private:
         ...
         */
        double surface_boundary_temperature;
