...
namespace aspect
{
  namespace GeometryModel
  {
     ...
     */
    template <int dim>
    class TwoMergedEllipsoidalChunks : public Interface<dim>, public SimulatorAccess<dim>
    {
      public:
        /**
      ...
      private:
        ...
        unsigned int EW_subdiv_lithosphere;
        unsigned int NS_subdiv_lithosphere;
        unsigned int depth_subdiv_lithosphere;
        unsigned int EW_subdiv_mantle;
        unsigned int NS_subdiv_mantle;
        unsigned int depth_subdiv_mantle;
