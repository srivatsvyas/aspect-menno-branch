...
#include <aspect/postprocess/visualization/relative_euler_pole_velocities_JdF.h>
...
namespace aspect
{
  namespace Postprocess
  {
    ...
    {
      template <int dim>
      RelativeEulerPoleVelocitiesJdF<dim>::
      RelativeEulerPoleVelocitiesJdF ()
        :
        DataPostprocessorVector<dim> ("relative_euler_pole_velocities_JdF",
...
namespace aspect
{
  namespace Postprocess
  {
    namespace VisualizationPostprocessors
    {
      ASPECT_REGISTER_VISUALIZATION_POSTPROCESSOR(RelativeEulerPoleVelocitiesJdF,
                                                  "relative Euler pole velocities JdF",
                                                  "")
    }
  }
}
