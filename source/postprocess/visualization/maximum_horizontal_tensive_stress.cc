...
#include <aspect/postprocess/visualization/maximum_horizontal_tensive_stress.h>
...
namespace aspect
{
  namespace Postprocess
  {
    namespace VisualizationPostprocessors
    {
      template <int dim>
      void
      MaximumHorizontalTensiveStress<dim>::
      ...
      MaximumHorizontalTensiveStress<dim>::get_names () const
      {
        return std::vector<std::string> (dim, "maximum_horizontal_tensive_stress");
      }


      template <int dim>
      std::vector<DataComponentInterpretation::DataComponentInterpretation>
      MaximumHorizontalTensiveStress<dim>::get_data_component_interpretation () const
      {
        return
          std::vector<DataComponentInterpretation::DataComponentInterpretation>
          (dim,
      ...
      template <int dim>
      UpdateFlags
      MaximumHorizontalTensiveStress<dim>::get_needed_update_flags () const
      {
...
namespace aspect
{
  namespace Postprocess
  {
    namespace VisualizationPostprocessors
    {
      ASPECT_REGISTER_VISUALIZATION_POSTPROCESSOR(MaximumHorizontalTensiveStress,
                                                  "maximum horizontal tensive stress",
